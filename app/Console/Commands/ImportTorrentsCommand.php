...
class ImportTorrentsCommand extends Command
{
     ...
     * @return void
     */
    public function __construct(ServiceInterface $service, TorrentMapperInterface $mapper, Cache $cache)
    {
        parent::__construct();
    ...
    private function cache(Torrent $torrent)
    {
        ...
        return Cache::put($torrent->infoHash, $entityHash);
    }
